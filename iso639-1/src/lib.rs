...
impl Iso639_1 {
    /// Returns the two letters string name.
    ///
    /// # Examples
    /// ```rust
    /// use iso639_1::Iso639_1;
...
impl TryFrom<&str> for Iso639_1 {
    ...
    fn try_from(language: &str) -> Result<Self, Self::Error> {
        match language {
            ...
            "zh" => Ok(Iso639_1::Zh),
            "zu" => Ok(Iso639_1::Zu),
            _ => Err(Iso639v1Error::from(Iso639v1ErrorKind::NotFoundFrom(
                language.to_string(),
            ))),
        }
    }
...
pub fn to_iso639_3(language: &str) -> Result<&str, Iso639v1Error> {
    match language {
        ...
        "zh" => Ok("zho"),
        "zu" => Ok("zul"),
        _ => Err(Iso639v1Error::from(Iso639v1ErrorKind::NotFoundTo(
            language.to_string(),
        ))),
    }
}
